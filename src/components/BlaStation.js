      ...
      <div className={styles.BlaStation}>
        ...
        <div className={styles.MobileText}>
          <p style={{ marginBottom: '0' }}>
            ...
            avoin ja utelias mieli saa aikaan näyttäviä, edellä aikaansa olevia
            uniikkeja ja ennakkoluulottomia tuotteita. Kaikki tuotetaan meitä
            lähellä, jokaiselle tuotteelle valitaan paras mahdollinen valmistaja
            ja koko tuotantoketjun ajan seurataan kestävän kehityksen
            kriteerejä.
          </p>
